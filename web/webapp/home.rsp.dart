...
<html>
  ...
  <table>
    ...
    <tr><td><label>Date</label></td><td><input type="datetime-local" id="time" required="required" name="time" max="$maxTime" placeholder="MM-DD-YYYY HH:MM AM" title="MM-DD-YYYY"/></td></tr>
